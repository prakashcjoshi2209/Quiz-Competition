    ...
    <div className="min-h-screen relative bg-gray-900 text-white overflow-hidden font-mono">
      ...
      >
        <button
          ...
          className="px-10 py-4 bg-gradient-to-r from-green-500 to-purple-500 text-white text-xl font-bold rounded-full shadow-lg transition duration-300"
        >
          GetStarted();
        </button>
      </motion.div>
