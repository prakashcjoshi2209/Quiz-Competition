  ...
  return (
    <div className="min-h-screen relative bg-gray-900 text-white overflow-hidden font-mono">
      ...
      <div className="relative z-10 flex justify-between items-center p-6 md:p-10">
        ...
        <div className="flex space-x-6 z-10">
          {['/aktu.png', '/abesit.jpg'].map((src, i) => (
            <motion.img
              ...
              className="h-20 w-20 sm:h-20 sm:w-20 md:h-24 md:w-24 rounded-full border-4 border-white shadow-lg object-cover"
            />
          ))}
        </div>
        ...
        {/* Other Logos */}
        <div className="flex space-x-6 z-10">
          {['/naaclogo.png', '/club.png'].map((src, i) => (
            <motion.img
              key={i}
              src={src}
              alt="Logo"
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-wide text-purple-400 drop-shadow">
          <span className="text-green-400">&lt;</span> CodeWarZone <span className="text-green-400">&gt;</span>
        </h1>
      ...
      >
        ...
        <p className="mt-4 text-lg max-w-2xl mx-auto text-gray-300">
          ...
          // Hit <span className="text-green-300">"GetStarted();"</span> and enter the 
      ...
      >
        ...
        <span className="text-sm text-xl text-gray-500">- Steve Jobs</span>
      </motion.div>
    </div>
  );
};
