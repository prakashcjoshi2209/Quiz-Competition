...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchLoginUsers = async () => {
      try {
        const response = await fetch('https://quiz-competition-6au4.onrender.com/api/auth/login-users');
        if (response.ok) {
  ...
  const fetchRound1Scores = async () => {
    ...
    try {
      const response = await fetch('https://quiz-competition-6au4.onrender.com/api/auth/round1-scores');
      if (response.ok) {
        const data = await response.json();
  ...
  const deleteLoginUser = async (id) => {
    try {
      const response = await fetch(`https://quiz-competition-6au4.onrender.com/api/auth/login-users/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const deleteRound1Score = async (id) => {
    try {
      const response = await fetch(`https://quiz-competition-6au4.onrender.com/api/auth/round1-scores/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
